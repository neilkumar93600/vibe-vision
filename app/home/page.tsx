...
import AdvancedVibeVisionLoading from "@/components/ui/loading-screen";
...
export default function HomePage() {
  ...
  return (
    <div>
      {isLoading ? (
        <AdvancedVibeVisionLoading
          onLoadComplete={handleLoadComplete} customIcons={["mdi:ghost-outline",
        "mdi:alien",
        "mdi:robot-confused", 
        "mdi:fire",
